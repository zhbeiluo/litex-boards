...
from litex_boards.platforms import xilinx_zu5ev
...
class BaseSoC(SoCCore):
    ...
    def __init__(self, sys_clk_freq, with_led_chaser=False, **kwargs):
        platform = xilinx_zu5ev.Platform()
        ...
        SoCCore.__init__(self, platform, sys_clk_freq, ident="LiteX SoC on ZU5EV", **kwargs)
...
def main():
    ...
    parser = LiteXSoCArgumentParser(description="LiteX SoC on ZU5EV")
